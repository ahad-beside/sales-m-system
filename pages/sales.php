        ...
        <!-- Content Header (Page header) -->
		  ...
		  <div class="box box-primary angel">
	      	<div class="box-header">
				<h3 class="box-title">Select Sales Date</h3>
			</div>
          ...
          <?php
		    $branch=$_SESSION['branch'];
			$sql = "SELECT * FROM `payment` natural join sales left join customer on payment.cust_id=customer.cust_id where date(trans_date)>='2018/01/01' and date(trans_date)<='2018/03/23' and payment.branch_id='$branch' ";
			//echo $sql;
          ...
          <tfoot>
          <tr>
            <th colspan=""><h4><b>Total Discount</b></h4></th>
	        <th style="text-align:right;"><h4><b><?php echo  number_format($discount,2);?></b></h4></th>
    	  </tr>
            
		  <tr>
 			<th colspan=""><h4><b>Total Shipping fee</b></h4></th>
        	<th style="text-align:right;"><h4><b><?php echo number_format($pgrand,2);?></b></h4></th>
          </tr>   
          
          <tr>
          	<th colspan=""><h4><b>Total Sales Payment</b></h4></th>
