            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <tr>
                    ...
                    <td><a href="#updateordinance<?php echo $row['prod_id'];?>" data-target="#updateordinance<?php echo $row['prod_id'];?>" data-toggle="modal" class="btn btn-primary">Cancel</a></td>
          		</tr>
