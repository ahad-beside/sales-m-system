<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				   ...
				   <li><a><i class="fa fa-building"></i>Inventory per branch <span class="fa fa-chevron-down"></span></a>
					...
					include('dbcon.php');
						...
						$id=$row['branch_id'];?>
                      <li><a href="inventory.php?id=<?php echo $row['branch_id'];?>"><?php echo $row ['ebay_name'];?></a></li>  
					<?php }?>
                    </ul>
                </li>
                ...
                <li><a href = "settings.php"><i class="fa fa-cog"></i> Setting<span class="fa fa-chevron-right"></span></a></li>
