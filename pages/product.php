          ...
          <section class="content">
            <div class="row">
              ...
              <div class="box box-primary">
                ...
                <tbody>
				<?php
					$query=mysqli_query($con,"SELECT * FROM `stockin` natural join category WHERE branch_id='$branch' order by cat_name")or die(mysqli_error());
                ...
                <tr>
                    ...
                    <td><a href="#updateordinance<?php echo $row['prod_id'];?>" data-target="#updateordinance<?php echo $row['prod_id'];?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-edit text-blue"></i></a></td>
                </tr>
				...
				<div id="updateordinance<?php if(($row['prod_qty']<>'0') and ($c>=$a)) echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
              ...
              <div class="form-group">
				...
				<div class="col-lg-9">
				<input type="text" class="form-control" id="catname" name="catname" value="<?php echo $row['cat_name'];?>" required readonly> 
                <input type="hidden" class="form-control" id="catid" name="catid" value="<?php echo $row['cat_id'];?>" readonly>                 
                </div><!-- /.input group -->
			  </div><!-- /.form group -->
              ...
              </div><!--./ modal-body end--><br><br><br><br><br><br><br>
   ...
   <?php include('../dist/includes/footer.php');?>
    ...
    <div class="modal-content" style="height:auto">
    	<div class="modal-header">
    		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        <span aria-hidden="true">×</span></button>
    	    <h4 class="modal-title">Add New Product Packet</h4>
	    </div>
        ...
        <div class="form-group">
        	<label class="control-label col-lg-3" >Category</label>
            <div class="col-lg-9">
            <select class="form-control" style="width: 100%;" name="category" placeholder="Product Price" required>
            <option></option>
            <?php
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Quantity Packet</label>
          <div class="col-lg-9">
          <input type="number" class="form-control" id="price" name="reorder" placeholder="Reorder Packet"  required>  
          </div>
        </div>
