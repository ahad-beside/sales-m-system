...
<html>
  <head>
    ...
    <title>Payment Receivables | <?php include('../dist/includes/title.php');?></title>
         ...
         <section class="content-header">
          ...
          <div class="row"><!-- ./row -->
            ...
            <th>Receivable</th>
				  ...
				  <?php
					$branch=$_SESSION['branch'];
			$sql="SELECT * FROM `payment` natural join sales left join customer on payment.cust_id=customer.cust_id where payment.branch_id='$branch' ";
			//echo $tt;
