...
?>      
             <h5 align="center"><b><?php echo $row['branch_name'];?></b> </h5>  
        <h6 align="center">Address: <?php echo $row['branch_address'];?></h6>
        <h6 align="center">Contact #: <?php echo $row['branch_contact'];?></h6>
        <h6 align="center"><b>Today, <?php echo date("M d, Y");?> <span id="tick2"></span></b></h6>
	  	<h5 align="center"><b>CREDIT SALES INVOICE of today, <?php echo date("M d, Y");?><span id="tick2"></span></b></h5>
